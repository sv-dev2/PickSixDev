...
namespace LatestTwitter.Models
{
    ...
    public class TwitterWidgetPart : ContentPart<TwitterWidgetRecord>
    {
        ...
        [Required]
        [DisplayName("Twitter OAuth Consumer Key")]
        public string TwitterConsumerKey
        {
            get { return Record.TwitterConsumerKey; }
            set { Record.TwitterConsumerKey = value; }
        }

        [Required]
        [DisplayName("Twitter OAuth Consumer Secret")]
        public string TwitterConsumerSecret
        {
            get { return Record.TwitterConsumerSecret; }
            set { Record.TwitterConsumerSecret = value; }
        }
    }
}