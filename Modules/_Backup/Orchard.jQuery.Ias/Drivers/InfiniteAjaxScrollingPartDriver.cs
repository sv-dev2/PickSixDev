...
using Orchard.jQuery.Ias.Settings;
using Orchard.UI.Notify;
using Orchard.Localization;

namespace LoadIn.Grapto.Media.Drivers
{
    public class InfiniteAjaxScrollingPartDriver : ContentPartDriver<InfiniteAjaxScrollingPart>
    {
        private const string TemplateName = "Parts/Orchard.jQuery.Ias";
        ...
        {            
            return ContentShape("Parts_Orchard_jQuery_Ias",
                                () => shapeHelper.Parts_Orchard_jQuery_Ias(ContentItem: part.ContentItem));
        }
